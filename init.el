...
;; (add-hook 'xquery-mode-hook 'display-line-numbers-mode)
;; (add-hook 'xquery-mode-hook 'abbrev-mode)
;; (add-hook 'xquery-mode-hook 'wrap-region-mode)
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(emacsql-sqlite3 emacsql-sqlite xquery-mode writegood-mode wrap-region wc-mode vertico use-package rainbow-mode rainbow-delimiters pdf-tools palimpsest org-wc org-roam org-ref org-pomodoro org-journal org-fancy-priorities org-contrib org-alert orderless openwith multiple-cursors move-text marginalia key-chord golden-ratio free-keys expand-region engine-mode elfeed-tube-mpv elfeed-org dired-narrow backup-each-save)))
(custom-set-faces
